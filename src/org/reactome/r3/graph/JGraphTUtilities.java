...
public class JGraphTUtilities {
    ...
    public static Graph<String, DefaultEdge> createGraph(Set<String> reactomeIds, 
...
//                          graph.edgeSet().size());        
     ...
     * @return
     */
    public static List<Set<String>> calculateGraphComponents(Set<String> interactions) {
